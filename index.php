...
<!--welcome-->
	...
	<div class="container">
			...
			<marquee behavior="scroll" scrollamount="5" direction="left" onmouseover="this.stop();" onmouseout="this.start();"><h3>Welcome to UIU NEXUS - An Interactive Alumni & Student Platform </h3>	
</marquee>
